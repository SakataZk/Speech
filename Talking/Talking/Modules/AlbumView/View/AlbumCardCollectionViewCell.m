...
@interface AlbumCardCollectionViewCell ()
/**
 *  图片
 */
...
@implementation AlbumCardCollectionViewCell
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [self.contentView addSubview:_mainTagLabel];
        ...
        [self.contentView addSubview:_subTagLabel];
