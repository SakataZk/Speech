...
- (void)GetAttention {
    ...
    NSString *url = [NSString stringWithFormat:@"http://app.ry.api.renyan.cn/rest/auth/subscribe/new/query_all?uid=189186&limit=10"];
...
- (void)addMoreAttention {
    ...
    [manager.requestSerializer setValue:@"A991B7D59DACB35A141ED180BF3EA6534F2B5E4FD8BAE126DF9BDAB620ABB39BDB73F66EB26933318FF792C0DDCF74D2C8C6D1E5978B351A70545ED860B91D8A" forHTTPHeaderField:@"X-AuthToken"];
    [manager.requestSerializer setValue:@"j8slb29fbalc83pna2af2c2954hcw65" forHTTPHeaderField:@"X-ApiKey"];
    NSString *url = [NSString stringWithFormat:@"http://app.ry.api.renyan.cn/rest/auth/subscribe/new/query_all?uid=189186&limit=10&last_sid=%@",[_sidArray lastObject]];
    [manager GET:url parameters:nil progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
