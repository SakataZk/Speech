...
#define selectedTitleAndIndicatorViewColor [UIColor blackColor]
...
/** 指示器的高度 */
static CGFloat const indicatorHeight = 0;
...
- (void)setStaticTitleArr:(NSArray *)staticTitleArr {
    ...
    for (NSInteger j = 0; j < self.staticTitleArr.count; j++) {
        ...
        _staticTitleLabel.textColor = [UIColor lightGrayColor];
...
- (void)staticTitleLabelSelecteded:(UILabel *)label {
    ...
    // 颜色恢复
    _selectedTitleLabel.textColor = [UIColor lightGrayColor];
...
- (void)setScrollTitleArr:(NSArray *)scrollTitleArr {
    ...
    for (NSUInteger i = 0; i < self.scrollTitleArr.count; i++) {
        ...
        _scrollTitleLabel.textColor = [UIColor lightGrayColor];
...
- (void)setShowsTitleBackgroundIndicatorStyle:(BOOL)showsTitleBackgroundIndicatorStyle {
    showsTitleBackgroundIndicatorStyle = showsTitleBackgroundIndicatorStyle;
